...
const SwarmCursor = ({
  color = '#a855f7',       // Electric Purple matching theme
  accentColor = '#06b6d4', // Cyan accent matching theme
  count = 14,
  size = 12,
  merge = 0.65,
  glow = 0.85,
  ...
  return (
    <div ref={containerRef} className={`swarm-cursor-wrapper ${className}`.trim()} style={style} {...rest}>
